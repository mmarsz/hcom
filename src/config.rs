...
impl HcomConfig {
    ...
    pub fn get_field(&self, field: &str) -> Option<String> {
        match field {
            ...
            "devin_args" => Some(self.devin_args.clone()),
    ...
    pub fn set_field(&mut self, field: &str, value: &str) -> Result<(), String> {
        match field {
            ...
            "devin_args" => self.devin_args = value.to_string(),
            "codex_sandbox_mode" => {
